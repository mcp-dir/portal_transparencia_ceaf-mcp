...
Portal da Transparência: Cadastro de Expulsões da Administração Federal (CEAF) usa um único endpoint público (`https://api.mcp.ai/p_portal_transparencia_ceaf`).
